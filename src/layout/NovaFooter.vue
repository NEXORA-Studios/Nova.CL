        ...
        <section class="flex gap-2 ml-auto mr-12">
            ...
            <div class="fab translate-y-1">
                ...
                <div tabindex="0" role="button" class="btn btn-lg btn-circle btn-primary">
                    <i class="icon-[material-symbols--action-key-outline-rounded] size-5.5"></i>
                </div>

                <!-- buttons that show up when FAB is open -->
                <div class="tooltip tooltip-left" :data-tip="$t('Footer.Tooltip.DownloadManager')">
                    <button class="btn btn-lg btn-circle btn-success aspect-square">
                        <i class="icon-[material-symbols--download-for-offline-outline-rounded] size-7 -m-3 text-base-content/90"></i>
                    </button>
                </div>
                <!-- <div
                    ...
                    ">
                    <button class="btn btn-lg btn-circle btn-warning aspect-square" @contextmenu.prevent="">
                ...
                <div class="tooltip tooltip-left" :data-tip="$t('Footer.Tooltip.KillAllMCInstance')">
                    <button class="btn btn-lg btn-circle btn-error aspect-square">
                        <i class="icon-[material-symbols--sentiment-extremely-dissatisfied-outline-rounded] size-7 -m-3"></i>
                    </button>
                </div>
            </div>
        </section>
